...
//        prop.putIfAbsent(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,"org.apache.kafka.common.serialization.StringSerializer");
//
//        //设置消费者组
...
//
//        //3 订阅主题
//        //用于创建一个只包含一个元素的不可变（unmodifiable）列表
